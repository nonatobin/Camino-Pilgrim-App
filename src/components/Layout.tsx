...
import { LogOut, User, Map as MapIcon, Activity, Users } from 'lucide-react';
...
export default function Layout({ children, activeTab, setActiveTab, user }: LayoutProps) {
  const tabs = [
    { id: 'plan', label: 'Training Plan', icon: MapIcon },
    { id: 'track', label: 'Start Walk', icon: Activity },
      ...
      <header className="bg-white border-b border-[#5A5A40]/10 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-[#5A5A40]">Camino Pilgrim</h1>
          </div>
